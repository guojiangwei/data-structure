...
class AbstractPanel:
    ...
    def reset(self):
        ...
        self.set_bgcolor(self._background_color)
        self._set_rect()
        self._set_content()
        self.draw_border()
        # print("widith,height:", self._width, self._height)
        self._changed = False
    ...
    def _process_text(self):
        self._font = pygame.font.SysFont(None, self._height - 2)
    ...
    def draw_border(self):
        pygame.draw.rect(self.surface, (255, 0, 230), ((0, 0), (self._width, self._height)), 1)
...
class OptionButton(Panel):
    ...
    def generate_item(self):
        for i in range(self._item_count):
            left_button = Button(x= 0, y=i*self.single_height, width= self.single_width, height= self.single_height)
            self.add(left_button)
            self._items.append(left_button)
            right_button = Button(x= self.single_width, y=i*self.single_height, width= self.single_width, height= self.single_height, text=self._texts[i])
